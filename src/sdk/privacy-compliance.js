...
(function(window, document) {
  ...
  function buildConsentUI(options) {
    ...
    // style attribute (position:<value>:0;) via string concatenation, so
    // an attacker-controllable `position` would otherwise be a CSS-
    // injection sink (expression(), background:url(javascript:...) on
    // legacy browsers, or attribute-breakout). Finding: audit Apr 21.
