...
2. **Behavioral composite** — 23 signals (21 weighted + 2 diagnostic-only) across motor, keystroke, decision, attention timing, reading, and cognitive-coherence domains. See [`BEHAVIORAL_SCIENCE_PATTERNS.md`](BEHAVIORAL_SCIENCE_PATTERNS.md).
