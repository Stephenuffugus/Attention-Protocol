...
**Verify every claim against:** the public repo at `https://sws-attention-proofs.web.app`, the live JWKS at `https://sws-attention-proofs.web.app/.well-known/attention-pubkey.json`, `src/sdk/*`, and the 754-test suite (`npm test`).
...
63 of the 754 regression tests are explicit security-regression tests mapped to the audit findings.
...
**Last updated:** 2026-04-21. Each answer cross-verifiable against the public repo, the live site, and the 754-test suite.
